...
class AppStore extends Component {
  ...
  getFilteredList = () => {
    ...
    const presentList = appsList.filter(
  ...
  render() {
    ...
    const filteredApps = this.getFilteredList()
    const filteredWithSearch = filteredApps.filter(eachApp =>
    ...
    return (
      <div className="bg-container">
        ...
        <ul className="apps-list">
          {filteredWithSearch.map(eachApp => (
